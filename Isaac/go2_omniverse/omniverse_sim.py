...
def setup_custom_env():
    # DEBUG: show exactly what flags we received
    ...
    try:
        ...
        cfg_scene.func("/World/warehouse", cfg_scene, translation=(-130.0, 31.0, 0.0))
        ...
        # # new “FarmNoMDL” loader
        # if args_cli.custom_env == "farm" and args_cli.terrain == "flat":
        #     print(f"    [DEBUG] → Matched farm + {args_cli.terrain}")
        #     # point to the USD in ./env/FarmNoMDL.usd (make sure it’s in that folder)
        #     cfg_scene = sim_utils.UsdFileCfg(usd_path="./envs/FarmNoMDL.usd")
        #     # you can pick any prim name under /World; here we call it “farm”
        #     cfg_scene.func("/World/farm", cfg_scene, translation=(0.0, 0.0, 0.0))
