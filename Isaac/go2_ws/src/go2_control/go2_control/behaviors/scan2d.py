...
class PointCloudToLaserScanNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('ground_filter_height', 0.15)  # meters above/below ground to skip
        
        self.ground_filter = self.get_parameter('ground_filter_height').value
